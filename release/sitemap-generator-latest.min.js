...
"danger"):(d="Your sitemap was generated successfully. You can download the sitemap now.",["WordPress","Joomla"].includes(a.systemName())&&(d="The generation of the sitemap was successful. The sitemap was saved as "+a.sitemapFilename()+" in the root folder of your "+a.systemName()+" instance. Please see the stats below."),a.setMessage(d,"success")),a.generateClass=a.btnDefaultClass(),a.downloadClass=a.btnPrimaryClass()):(a.pageCount=d.page_count,0<a.pageCount&&(d="The sitemap is being generated. Please wait a moment.<br />"+
